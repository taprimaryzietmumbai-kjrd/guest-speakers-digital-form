...
function toggleOther(){
  document
    .getElementById("otherWrap")
    .classList.toggle(
      "hidden",
      document.getElementById("organization").value!=="Others"
    );
}
...
document.getElementById("speakerForm").addEventListener(
  "submit",
  async e=>{
    ...
    const data={
      ...
      organization:
        org==="Others"
          ? (
              document.getElementById("otherOrg").value.trim()
              || "Others"
            )
          : org,
